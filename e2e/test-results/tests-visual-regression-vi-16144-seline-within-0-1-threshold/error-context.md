...
- Name: tests/visual/regression.spec.ts >> visual-regression >> keymap overlay matches baseline within 0.1% threshold
- Location: tests/visual/regression.spec.ts:74:3
