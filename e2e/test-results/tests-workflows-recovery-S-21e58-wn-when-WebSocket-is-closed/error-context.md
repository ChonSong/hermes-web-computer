...
- Name: tests/workflows/recovery.spec.ts >> Session Recovery Workflow >> verify disconnect UI is shown when WebSocket is closed
- Location: tests/workflows/recovery.spec.ts:65:3
