...
- Name: tests/workflows/chat-context.spec.ts >> Chat Context Workflow >> send message via send button (not Enter key)
- Location: tests/workflows/chat-context.spec.ts:71:3
