...
- Name: tests/visual/regression.spec.ts >> visual-regression >> disconnected state matches baseline within 0.1% threshold
- Location: tests/visual/regression.spec.ts:58:3
