...
- Name: tests/workflows/pipeline.spec.ts >> Multi-Terminal Pipeline Workflow >> verify output visibility across split terminals
- Location: tests/workflows/pipeline.spec.ts:132:3
