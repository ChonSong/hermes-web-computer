...
- Name: tests/workflows/pipeline.spec.ts >> Multi-Terminal Pipeline Workflow >> launch Terminal 2 (split), verify layout changes
- Location: tests/workflows/pipeline.spec.ts:52:3
