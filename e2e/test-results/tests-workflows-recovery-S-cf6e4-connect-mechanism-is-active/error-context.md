...
- Name: tests/workflows/recovery.spec.ts >> Session Recovery Workflow >> verify auto-reconnect mechanism is active
- Location: tests/workflows/recovery.spec.ts:123:3
