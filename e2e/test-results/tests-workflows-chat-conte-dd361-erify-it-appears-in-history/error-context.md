...
- Name: tests/workflows/chat-context.spec.ts >> Chat Context Workflow >> type message in right panel, press Enter, verify it appears in history
- Location: tests/workflows/chat-context.spec.ts:11:3
