...
- Name: tests/workflows/cross-panel.spec.ts >> Cross-Panel Interaction Workflow >> create file via terminal, verify it appears in file tree, open in editor
- Location: tests/workflows/cross-panel.spec.ts:11:3
