...
- Name: tests/workflows/pipeline.spec.ts >> Multi-Terminal Pipeline Workflow >> launch Terminal 3 (2x2 grid), then close one and verify reflow
- Location: tests/workflows/pipeline.spec.ts:77:3
