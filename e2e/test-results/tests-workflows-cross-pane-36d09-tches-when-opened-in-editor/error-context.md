...
- Name: tests/workflows/cross-panel.spec.ts >> Cross-Panel Interaction Workflow >> create file in terminal, verify content matches when opened in editor
- Location: tests/workflows/cross-panel.spec.ts:139:3
