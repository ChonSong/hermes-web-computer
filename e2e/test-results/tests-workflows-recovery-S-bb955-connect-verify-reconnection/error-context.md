...
- Name: tests/workflows/recovery.spec.ts >> Session Recovery Workflow >> verify connected state, simulate disconnect, verify reconnection
- Location: tests/workflows/recovery.spec.ts:11:3
