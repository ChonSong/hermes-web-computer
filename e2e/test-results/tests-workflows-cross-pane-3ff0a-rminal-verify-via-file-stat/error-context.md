...
- Name: tests/workflows/cross-panel.spec.ts >> Cross-Panel Interaction Workflow >> create file via terminal, verify via file stat
- Location: tests/workflows/cross-panel.spec.ts:60:3
