...
- Name: tests/chaos/ws-flood.spec.ts >> ws-flood >> survives concurrent WS connections from same page
- Location: tests/chaos/ws-flood.spec.ts:95:3
...
> 96  |     await page.goto('/')
  ...
  110 |         }))
  111 |       }
  112 |       // Close all after a moment
  113 |       await new Promise<void>((resolve) => {
  114 |         setTimeout(() => {
  115 |           sockets.forEach(s => s.close())
  116 |           resolve()
  117 |         }, 2000)
  118 |       })
  119 |     })
  120 | 
  121 |     // Page should remain stable
  122 |     await expect(page.locator('#app')).toBeVisible()
  123 |   })
  124 | })
  125 | 
```